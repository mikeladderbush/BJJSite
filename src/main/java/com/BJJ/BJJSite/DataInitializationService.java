 ...
 * 
 * This service is responsible for creating demo users and associated payment
 * options, as well as populating the database with initial data.
 */
@Service
public class DataInitializationService {
     ...
     * 
     * This method is executed automatically after the service is constructed and is
     * annotated with @PostConstruct.
     * It creates a demo user with associated payment options and roles, and then
     ...
     *                .lastname("Ladderbush")
     *                .username("mikeladder")
     *                .password(passwordEncoder.encode("mike")) // Encode the
     *                password
     ...
     *                PaymentOption demoPaymentOption =
     *                paymentOptionFactory.createPaymentOption(builder -> {
     ...
     * 
     *                // Save the User, which will also save the PaymentOption due
     *                to cascading
     *                userService.createUser(demoUser.get());
     *                System.out.println("User saved successfully with payment
     *                option.");
     *                } else {
